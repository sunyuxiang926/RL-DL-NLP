...
def get_args():
    ...
    # Add data arguments
    parser.add_argument('--data', default='your destination', help='path to data directory')
    parser.add_argument('--checkpoint-path', default='checkpoint_best.pt', help='path to the model file')
    ...
    parser.add_argument('--stop-early', default='False', help='stop generation immediately after finalizing hypotheses')
