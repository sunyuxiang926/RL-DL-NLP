...
def get_args():
    ...
    # Add data arguments
    parser.add_argument('--data', default='your data path', help='path to data directory')
    parser.add_argument('--max-tokens', default=16000, type=int, help='maximum number of tokens in a batch')#16000
    parser.add_argument('--batch-size', default=150, type=int, help='maximum number of sentences in a batch')#120
    parser.add_argument('--num-workers', default=multiprocessing.cpu_count(), type=int, help='number of data workers')

    # Add model arguments
    parser.add_argument('--arch', default='show_tell', choices=ARCH_MODEL_REGISTRY.keys(), help='model architecture')

    # Add optimization arguments
    parser.add_argument('--max-epoch', default=100, type=int, help='force stop training at specified epoch')#100
    ...
    parser.add_argument('--log-file', default='logs/show_tell.log', help='path to save logs')
    parser.add_argument('--save-dir', default='checkpoints/new_show_tell', help='path to save checkpoints')
